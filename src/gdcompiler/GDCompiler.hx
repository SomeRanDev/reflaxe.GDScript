...
description="${Context.definedValue(Define.GodotPluginDescription) ?? "Generated by Reflaxe/GDScript"}"
author="${Context.definedValue(Define.GodotPluginAuthor) ?? ""}"
version="${Context.definedValue(Define.GodotPluginVersion) ?? ""}"
